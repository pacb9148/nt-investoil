    ...
    return (
      <div className="w-full space-y-1.5">
        ...
        <textarea
          ...
          ref={ref}
          className={cn(
            'flex min-h-[110px] w-full rounded-lg border border-border bg-surf/90 px-3.5 py-2.5 text-sm text-text placeholder:text-text-subtle transition-all duration-200',
