...
export const TEAM_MEMBERS: TeamMember[] = [
  {
    id: 't-01',
    number: '#01',
    name: 'Rufino Antonio Villalobos',
    role: 'Director General & CEO',
    location: 'Madrid / Houston',
    image: '',
  },
  {
    id: 't-02',
    number: '#02',
    name: 'Elena Torres',
    role: 'Directora de Riesgos y Cumplimiento',
    location: 'Madrid',
    image: '/uploads/1790321520353-descarga__11_.jpg',
  },
  {
    id: 't-03',
    number: '#03',
    name: 'Marco Ferreira',
    role: 'Jefe de Logística Marítima',
    location: 'Lisboa / Rotterdam',
    image: '/uploads/1790321287557-descarga__37_.jpg',
  },
  {
    id: 't-04',
    number: '#04',
    name: 'Aisha Rahman',
    role: 'Responsable de Cumplimiento EMEA',
    location: 'Dubái',
    image: '/uploads/1790321301511-descarga__8_.jpg',
  },
  {
    id: 't-05',
    number: '#05',
    name: 'Paulo DaSilva',
    role: 'Analista Senior de Mercado de Crudos',
    location: 'Singapur / Houston',
    image: '/images/team/paulo-dasilva.jpg',
  },
  {
    id: 't-06',
    number: '#06',
    name: 'Pablo Alonso Costales',
    role: 'Director Comercial Latam',
    location: 'Madrid / Bogotá / Caracas',
    image: '/uploads/1790321316798-2026-09-24_230839.png',
  },
];
